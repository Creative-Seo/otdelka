...
После завершения всех работ мы подготавливаем объект к сдаче, производим финишную уборку и передаем ключи клиенту
						...
						<div id="testimonial-nav">
							...
							<a href="javascript:;" class="client" style=".client:hover{display: block;}" data-client="Обращение клиента в компанию"><img src="/assets/img/d/1.jpg" alt="client"></a><i class="glyphicon glyphicon-chevron-right"></i>
