...
<?if($page->slug == 'index'):?>
	...
	<div id="hero-text-hold" class="hero-text">
		<div>
			...
			<p>Отделочные работы с четйкими гарантиями, прописанными в договоре.<br>Составление четкой детальной сметы не меняющаяся в процессе работ.<br>Оплата по факту выполнения работ без аванса.</p>
		</div><!-- end .hero-text -->
